...
describe('immutability', () => {
  ...
  describe('a list', () => {
    ...
    it('is immutable', () => {
      ...
      let nextState = addMovie(state, 'Terminator');

      expect(nextState).to.equal(List.of('Trainspotting', '28 days later', 'Terminator'));
  ...
  describe('a tree', () => {
    ...
    it('is immutable', () => {
      ...
      expect(nextState).to.equal(Map({movies: List.of('Trainspotting', '28 days later', 'Terminator')}));
